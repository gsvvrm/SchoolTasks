...
private const val TAG = "ThursdayFragment"
...
class ThursdayFragment : Fragment() {
    ...
    private lateinit var subjThursdayRecyclerView : RecyclerView
    private var adapter: ThursdayFragment.SubjThursdayAdapter? = SubjThursdayAdapter(emptyList())
    ...
    override fun onCreateView(
        ...
        subjThursdayRecyclerView = view.findViewById(R.id.subj_thursday_recycler_view) as RecyclerView
        subjThursdayRecyclerView.layoutManager = LinearLayoutManager(context)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        jobViewModel.getSubjectsForThursday().observe(viewLifecycleOwner, Observer {
                subjects -> subjects?.let {

            Log.i(TAG,"В четверг ${subjects.size} предметов")
            updateUI(subjects)
        }
        })
    ...
    private inner class SubjThursdayHolder (view: View) : RecyclerView.ViewHolder(view),View.OnClickListener {
        ...
        //val itemShedSubjJob: TextView = itemView.findViewById(R.id.item_shed_subj_job)
        private var adapter: SubjThursdayHolder.ItemRecyclerAdapter? = ItemRecyclerAdapter(emptyList())
    ...
    private inner class SubjThursdayAdapter (var subjects: List<Subject>): RecyclerView.Adapter<SubjThursdayHolder>() {
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SubjThursdayHolder {
            val view = layoutInflater.inflate(R.layout.list_item_subject_shedule,parent,false)
            return SubjThursdayHolder(view)
        }

        override fun onBindViewHolder(holder: SubjThursdayHolder, position: Int) {
    ...
    private fun updateUI(subjects: List<Subject>){
        adapter = SubjThursdayAdapter(subjects)
        subjThursdayRecyclerView.adapter = adapter
    }
