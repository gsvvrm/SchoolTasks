...
private const val TAG = "WednesdayFragment"
...
class WednesdayFragment : Fragment() {
    ...
    private lateinit var subjWednesdayRecyclerView : RecyclerView
    private var adapter: WednesdayFragment.SubjWednesdayAdapter? = SubjWednesdayAdapter(emptyList())
    ...
    override fun onCreateView(
        ...
        subjWednesdayRecyclerView = view.findViewById(R.id.subj_wednesday_recycler_view) as RecyclerView
        subjWednesdayRecyclerView.layoutManager = LinearLayoutManager(context)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        jobViewModel.getSubjectsForWednesday().observe(viewLifecycleOwner, Observer {
                subjects -> subjects?.let {

            Log.i(TAG,"В вреду ${subjects.size} предметов")
            updateUI(subjects)
        }
        })
    ...
    private inner class SubjWednesdayHolder (view: View) : RecyclerView.ViewHolder(view),View.OnClickListener {
        ...
        //val itemShedSubjJob: TextView = itemView.findViewById(R.id.item_shed_subj_job)
        private var adapter: SubjWednesdayHolder.ItemRecyclerAdapter? = ItemRecyclerAdapter(emptyList())
    ...
    private inner class SubjWednesdayAdapter (var subjects: List<Subject>): RecyclerView.Adapter<SubjWednesdayHolder>() {
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SubjWednesdayHolder {
            val view = layoutInflater.inflate(R.layout.list_item_subject_shedule,parent,false)
            return SubjWednesdayHolder(view)
        }

        override fun onBindViewHolder(holder: SubjWednesdayHolder, position: Int) {
    ...
    private fun updateUI(subjects: List<Subject>){
        adapter = SubjWednesdayAdapter(subjects)
        subjWednesdayRecyclerView.adapter = adapter
    }
